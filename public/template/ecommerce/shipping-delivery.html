...
<head>
    ...
    <title>Kalle's shipping and delivery</title>
    ...
    <div id="nt_content">
        ...
        <div class="container mt__40 mb__40 cb">
            <div class="kalles-term-exp mb__30">
                ...
                <p class="mb-2">At Look, we provide FREE Standard delivery to any address within Global. However, do note that we do not deliver to PO Boxes, military and restricted areas, all naval ports and Jurong Island.</p>
            ...
            <div class="kalles-term-exp mb__30">
                ...
                <b class="d-block mb-2">There are 2 delivery options available for customer, Standard and Express courier.</b>
                <p class="mb-2"><strong><em>Standard Courier </em></strong>– is FREE for all local orders and it takes approximately 5 working days to reach you from the time of order.</p>
                ...
                <p class="mb-2">To serve you better, you may even choose the timing of your deliveries from 9am to 10pm, weekdays or Saturdays, regardless of Standard or Express couriers.<br> Once the order has been dispatched, an email confirmation will be sent to you with the tracking number. You may check and track the delivery status of your orders with our local logistics partner, with your 6-digit Order Number. There will be an additional charge for re-delivery should nobody be present to receive the package. Please provide your contact number under the address selected upon checkout in order for the courier company to contact you in case of any unforeseen circumstances.</p>
                <p>For all international deliveries, the time taken is dependent on our logistics partners and their affiliates. However, rest assured that your order is safely on its way and may track its status here.</p>
            </div>
            <div class="kalles-term-exp mb__30">
                <h3 class="fs__18 mt-0">3. TAXES, DUTIES & TARIFFS</h3>
            ...
            <div class="kalles-term-exp mb__30">
                <h3 class="fs__18 mt-0">4. MODE OF PAYMENTS</h3>
                <p>We accept payments via VISA/MASTER credit and debit cards, American Express and PayPal. Please visit www.paypal.com for more information. We do not accept payments via ATM or inter-bank transfers.</p>
            </div>
        </div>
        <!--end page content-->
