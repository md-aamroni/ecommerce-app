...
<head>
    ...
    <title>Kalle's store location</title>
    ...
    <div id="nt_content">
        ...
        <div class="kalles-section page_section_heading">
            <div class="page-head tc pr oh cat_bg_img page_head_">
                ...
                <div class="container pr z_100">
                    <h1 class="mb__5 cw">Store Location</h1>
                </div>
            </div>
        </div>
        <!--end hero banner-->
        ...
        <div class="container cb">
            <div class="kalles-term-exp mt__40">
                <h3 class="mg__0 mb-0">BULGARIA</h3>
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="store-local mt__20">
                            <h4 class="mt-0 mb-2">Mall Varna</h4>
                            <p class="mb-1">186 Vladislav Varnenchik Blvd.2nd floor, store No.18 Varna 9000</p>
                            <p class="mb-0">Tel: +359-893 695881</p>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="store-local mt__20">
                            <h4 class="mt-0 mb-2">Central pedestrian area</h4>
                            <p class="mb-1">23 Knyaz Boris I Blvd Varna 9000</p>
                            <p class=mb-0>Tel: +359-893 695882</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="kalles-term-exp mt__40">
                <h3 class="mg__0 mb-0">DUBAI</h3>
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="store-local mt__20">
                            <h4 class="mt-0 mb-2">Mall of the Emirates</h4>
                            <p class="mb-1">4th Interchange, Sheikh Zayed Road 1st Level</p>
                            <p class="mb-0">Tel: +971-4 341 3666</p>
                        </div>
                        <div class="store-local mt__20">
                            <h4 class="mt-0 mb-2">Deira City Centre</h4>
                            <p class="mb-1">8th Street Deira 1st Level</p>
                            <p class="mb-0">Tel: +971-4 295 0790</p>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="store-local mt__20">
                            <h4 class="mt-0 mb-2">Mercato</h4>
                            <p class="mb-1">Jumeirah Beach Rd 1st Level</p>
                            <p class="mb-0">Tel: +971-4 344 0015</p>
                        </div>
                        <div class="store-local mt__20">
                            <h4 class="mt-0 mb-2">Seminyak</h4>
                            <p class="mb-1">Jl. Raya Seminyak No.9, Bali 80361</p>
                            <p class="mb-0">Tel: +62-361 733462</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="kalles-term-exp mt__40 mb__40">
                <h3 class="mg__0 mb-0">INDONESIA</h3>
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="store-local mt__20">
                            <h4 class="mt-0 mb-2">Central Park</h4>
                            <p class="mb-1">UG Floor Unit-123A, Jl. Let Jend S.Parman Kav.28, Jakarta Barat 11470</p>
                            <p class="mb-0">Tel: +62-21 29200095</p>
                        </div>
                        <div class="store-local mt__20">
                            <h4 class="mt-0 mb-2">Pondok Indah Mall 2</h4>
                            <p class="mb-1">1st Floor #127, Jl. Metro Pondok Indah Blok 3B, Jakarta Selatan 12310</p>
                            <p class="mb-0">Tel: +62-21 75920987</p>
                        </div>
                        <div class="store-local mt__20">
                            <h4 class="mt-0 mb-2">Paris Van Java</h4>
                            <p class="mb-1">Resort Level #D-06, Jl. Sukajadi No.137-139, Bandung 40162</p>
                            <p class="mb-0">Tel: +62-22 82063875</p>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="store-local mt__20">
                            <h4 class="mt-0 mb-2">Gandaria City</h4>
                            <p class="mb-1">UG Floor Unit 61, Jl. KH Syafi¡¯I Hadzami, Jakarta Selatan 12240</p>
                            <p class="mb-0">Tel: +62-21 29007806</p>
                        </div>
                        <div class="store-local mt__20">
                            <h4 class="mt-0 mb-2">Galaxy Mall</h4>
                            <p class="mb-1">1st Floor, Unit 125-126, Jl. Dharma Husada Indah Timur No.37, Surabaya 60115</p>
                            <p class="mb-0">Tel: +62-31 5937282</p>
                        </div>
                    </div>
                </div>
            </div>
