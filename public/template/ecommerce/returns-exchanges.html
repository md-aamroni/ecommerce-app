...
<head>
    ...
    <title>Kalle's returns and exchanges</title>
                            ...
                            <div class="col-lg-4 col-12 tc col-md-12 tr_lg ">
                                <div class="nt_currency pr cg currencies sp_currencies wsn dib  cur_stt_0">
                                    ...
                                    <ul class="pa pe_none ts__03 bgbl ul_none tl op__0 z_100 r__0 pt__15 pb__15 pr__15 pl__15">
                                        <li><a class="nt-currency-flag--aud--w16-h-12 cg db" href="#">AUD</a></li>
                                        <li><a class="nt-currency-flag--cad--w16-h-12 cg db" href="#">CAD</a></li>
                                        <li><a class="nt-currency-flag--dkk--w16-h-12 cg db" href="#">DKK</a></li>
                                        <li><a class="nt-currency-flag--eur--w16-h-12 cg db" href="#">EUR</a></li>
                                        <li><a class="nt-currency-flag--gbp--w16-h-12 cg db" href="#">GBP</a></li>
                                        <li><a class="nt-currency-flag--hkd--w16-h-12 cg db" href="#">HKD</a></li>
                                        <li><a class="nt-currency-flag--jpy--w16-h-12 cg db" href="#">JPY</a></li>
                                        <li><a class="nt-currency-flag--nzd--w16-h-12 cg db" href="#">NZD</a></li>
                                        <li><a class="nt-currency-flag--sgd--w16-h-12 cg db" href="#">SGD</a></li>
                                        <li><a class="nt-currency-flag--usd--w16-h-12 cg db selected" href="#">USD</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col dn db_lg">
                                <nav class="nt_navigation kl_navigation tc hover_side_up nav_arrow_false">
                                    <ul id="nt_menu_id" class="nt_menu in_flex wrap al_center">
                                        ...
                                        <li class="type_mega menu_wid_cus menu-item has-children menu_has_offsets menu_center pos_center">
                                            <a class="lh__1 flex al_center pr" href="shop-filter-sidebar.html">Shop
                                        ...
                                        <li class="type_dropdown menu-item has-children menu_has_offsets menu_right pos_right">
                                            ...
                                            <div class="sub-menu">
                                                <div class="lazy_menu lazyload">
                                                    <div class="menu-item">
                                                        <a href="portfolio.html">Portfolio 2 Columns</a></div>
                                                    <div class="menu-item">
    ...
    <div id="nt_content">
        ...
        <div class="kalles-section page_section_heading">
            <div class="page-head tc pr oh cat_bg_img page_head_">
                ...
                <div class="container pr z_100">
                    <h1 class="mb__5 cw">Returns & Exchanges</h1>
                </div>
            </div>
        </div>
        <!--end hero banner-->
        ...
        <div class="container mt__40 mb__40 cb">
            <div class="kalles-term-exp mb__30">
                <h2 class="fs__22 mt-0">RETURNS &amp; EXCHANGES POLICY</h2>
                ...
                <p>If non of the above conditions are met, we regret to inform that we are unable to process any claims for exchanges or refund regardless that the items have been mailed back to us.<strong class="d-block mt__5"><em>Sales item(s) are non-exchangeable nor returnable either in our retail boutique or via our online portal.</em></strong>
                </p>
            </div>
            <div class="kalles-term-exp mb__30">
                <h3 class="fs__18 mt-0">1. VALIDITY FOR EXCHANGES &amp; RETURNS</h3>
                <p>All exchanges and returns would need to be raised within 10 days of the invoice date for Singapore orders, and 20 days for overseas orders. For local deliveries, there is an option to exchange at any of our boutiques within Singapore or through our online portal at
                    <a href="http://www.company.com/">www.company.com</a>. All requests for returns however, would need to be strictly made online at
                    <a href="http://www.company.com/">www.company.com</a> for both local and overseas deliveries.</p>
            </div>
            <div class="kalles-term-exp mb__30">
                <h3 class="fs__18 mt-0">2. EXCHANGES AT OUR BOUTIQUES</h3>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">2.1</span> You will need to bring along your original invoice together with the item(s) in its original condition and packaging to any of our boutiques.
                </p>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">2.2</span> You will be entitled to an exchange of any item(s) in the boutique immediately after evaluation by our retail associates that it is valid.
                </p>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">2.3</span> If the value of the exchange item(s) is higher than the original item(s), you will be required to top up the difference in cash.
                </p>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">2.4</span> There will be no refund if the value of the exchange item(s) is lower than the original item(s).
                </p>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">2.5</span> No other forms of exchanges (such as boutique cash vouchers or online store credit) will be given at our boutiques.
                </p>
            </div>

            <div class="kalles-term-exp mb__30">
                <h3 class="fs__18 mt-0">3. EXCHANGES &amp; RETURNS ONLINE</h3>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">3.1</span> You will need to include your original invoice together with the item(s) in its original condition and packaging.
                </p>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">3.2</span> Kindly print and fill up the Exchange/Return Request Form here and follow the steps indicated in the form for your exchange.
                </p>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">3.3</span> Mail us your parcel via a traceable mode of postage.</p>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">3.4</span> Wait for our email confirmation and you will be notified once your online Store Credit Voucher is ready.&nbsp; Generally, the processing period is 5 working days upon receipt of your parcel.
                </p>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">3.5</span> All requests for returns will be refunded via online Store Credit Vouchers only. Your online Store Credit Voucher is valid for 30 days and can be used for your next purchase online. It is strictly non refundable, non extendable, non exchangeable for cash and non exchangeable for boutique vouchers. The online Store Credit Voucher is applicable online only and cannot be used in our Retail boutiques.
                </p>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">3.6</span> Online Store Credit Vouchers are to be used in a singular transaction and any excess amount not utilized, would not be refunded.
                </p>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">3.7</span> Online Store Credit Vouchers given will be at the buying price of the product as stated in the original invoice. No refunds will be given for delivery charges incurred in the original, returned and onward shipping charges of exchanged items.
                </p>
                <p class="mb__5 d-flex">
                ...
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">3.9</span> No refunds will be given for taxes, duties, tariffs and excise charges levied for overseas orders either for refunds or exchanged items.
                </p>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">3.10</span> All returns and exchanges made via our online portal at www.company.com would need to be shipped to :
                </p>
                <ul class="pl__30">
            ...
            <div class="kalles-term-exp mb__30">
                <h3 class="fs__18 mt-0">4. OTHER TERMS &amp; CONDITIONS</h3>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">4.1</span> All items that are returned and exchanged, can only be made once.
                </p>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">4.2</span> We reserve the right and full discretion to disqualify you from enjoying free returns if the subsequent item(s) for return or exchange are of the same item(s) as a previous order
                </p>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">4.3</span> Our returns and exchanges policy does not cover damage resulting from unique, accidental, or random damage that is the result of use by you or wear and tear of a product.
                </p>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">4.4</span> BeetleBug makes no warranty in respect of any product, express or implied, including any implied warranties of merchantability, quality, compliance with description and fitness for a particular purpose.
                </p>
                <p class="mb__5 d-flex">
                    <span class="fwm mr__5">4.5</span> Such returns are at all times governed by the provisions of the Consumer Protection (Fair Trading) Act of Singapore.
                </p>
                <p class="mb__5 d-flex"><span class="fwm mr__5">4.6</span> All decisions made by BeetleBug.com is final.
                </p>
            </div>

            <div class="kalles-term-exp mb__30">
                <h3 class="fs__18 mt-0">5. REPAIR POLICY</h3>
                <p>We offer repair services for all our products. Kindly visit us at any of our boutiques in Singapore for more information or contact us at<a href="mailto:marketing@company.com">marketing@company.com</a>
                </p>
            </div>
        </div>
        <!--end page content-->
                ...
                <div class="container pr tc">
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-12 col_1">Copyright © 2021
                            <span class="cp">Kalles</span> all rights reserved. Powered by
                            <a href="https://themes.the4.co/kalles-html">The4</a></div>
                    ...
                    <div class="gecko-scroll-content-quick">
                        <div class="kalles-section-pr_summary kalles-section summary entry-summary mt__30">
                            <h1 class="product_title entry-title fs__16">
                                <a href="product-detail-layout-01.html">La Bohème Rose Gold</a></h1>
            ...
            <div class="search_header__content mini_cart_content fixcl-scroll widget">
                <div class="fixcl-scroll-content product_list_widget">
                    <div class="js_prs_search">
                        ...
                        <div class="row mb__10 pb__10">
                            <div class="col widget_img_pr">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%20768%20768%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lazyload" alt="cru thermos jug" data-src="assets/images/mini-cart/product-02.jpg" width="80" height="80"></a>
                            </div>
                            <div class="col widget_if_pr">
                        ...
                        <div class="row mb__10 pb__10">
                            <div class="col widget_img_pr">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%20768%20768%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lazyload" alt="brush set small" data-src="assets/images/mini-cart/product-03.jpg" width="80" height="80"></a>
                            </div>
                            <div class="col widget_if_pr">
                        ...
                        <div class="row mb__10 pb__10">
                            <div class="col widget_img_pr">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%20768%20768%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lazyload" alt="stripe oilcloth" data-src="assets/images/mini-cart/product-04.jpg" width="80" height="80"></a>
                            </div>
                            <div class="col widget_if_pr">
                        ...
                        <div class="row mb__10 pb__10">
                            <div class="col widget_img_pr">
                                <a class="db pr oh" href="product-detail-layout-01.html"><img src="data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%20768%20768%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3C%2Fsvg%3E" class="w__100 lazyload" alt="picto wall clock" data-src="assets/images/mini-cart/product-05.jpg" width="80" height="80"></a>
                            </div>
                            <div class="col widget_if_pr">
