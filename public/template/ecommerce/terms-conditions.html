...
<head>
    ...
    <title>Kalle's terms conditions</title>
    ...
    <div id="nt_content">
        ...
        <div class="kalles-section container mt__50 mb__50">
            <div class="terms cb">
                ...
                <div class="kalles-term-exp mb__20">
                    <h3 class="fs__18 mt-0">Limitations of Liability</h3>
                ...
                <div class="kalles-term-exp mb__20">
                    <h3 class="fs__18 mt-0">Duties and Taxes</h3>
                ...
                <div class="kalles-term-exp mb__20">
                    <h3 class="fs__18 mt-0">Exchange and Refund Policy (Singapore Outlets Only)</h3>
