...
<head>
    ...
    <title>Kalle's size guild</title>
    ...
    <div id="nt_content">
        ...
        <div class="kalles-section page_section_heading">
            <div class="page-head tc pr oh cat_bg_img page_head_">
                ...
                <div class="container pr z_100">
                    <h1 class="mb__5 cw">Size chart</h1>
                </div>
            </div>
        </div>
        <!--end hero banner-->
        ...
        <div class="container cb">
            <div class="first-column">
                <h3 class="mt__40 mb__20 fs__20">Sizing &amp; Fit Guide</h3>
                <p class="mb-2">Please be aware that most of our clothing is Juniors' sizing, which runs smaller than regular US / European Women sizing. Refer to the measurements chart for each individual product to determine the best size for you. Product specific size chart and information can be found in product description or in product picture gallery.</p>
            ...
            <div class="second-column">
                <h3 class="mt__40 mb__20 fs__20">Find the best size</h3>
            ...
            <hr class="hr">
            <h3 class="text-center text-center mt-0 mb__30 fs__20">kalles Size Chart</h3>
            <div class="tabset mb__10 ml-auto mr-auto">
                <!-- Tab 1 -->
                ...
                <div class="tab-panels">
                    <section id="size-chart-tab-content__dresses" class="tab-panel">
                        <div class="size-chart-tab-content__wrap-tbl mb__40">
                            <h5 class="mb__20 fs__16">Dress Size Chart (Inch)</h5>
                        ...
                        <div class="size-chart-tab-content__wrap-tbl">
                            <h5 class="mb__20 fs__16">Dress Size Chart (cm)</h5>
                            <div class="table-responsive">
                                <table class="sizeguide_table w__100 m-0">
                                    <tbody>
                                    <tr>
                    ...
                    <section id="size-chart-tab-content__tops" class="tab-panel">
                        <div class="size-chart-tab-content__wrap-tbl mb__40">
                            <h5 class="mb__20 fs__16">Tops Size Chart (Inch)</h5>
                            <div class="table-responsive">
                                <table class="sizeguide_table w__100 m-0">
                                    <tbody>
                                    <tr>
                        ...
                        <div class="size-chart-tab-content__wrap-tbl">
                            <h5 class="mb__20 fs__16">Tops Size Chart (cm)</h5>
                            <div class="table-responsive">
                                <table class="sizeguide_table w__100 m-0">
                                    <tbody>
                                    <tr>
                    ...
                    <section id="size-chart-tab-content__bottoms" class="tab-panel">
                        <div class="size-chart-tab-content__wrap-tbl mb__40">
                            <h5 class="mb__20 fs__16">Bottoms Size Chart (Inch)</h5>
                            <div class="table-responsive">
                                <table class="sizeguide_table w__100 m-0">
                                    <tbody>
                                    <tr>
                        ...
                        <div class="size-chart-tab-content__wrap-tbl">
                            <h5 class="mb__20 fs__16">Bottoms Size Chart (cm)</h5>
                            <div class="table-responsive">
                                <table class="sizeguide_table w__100 m-0">
                                    <tbody>
                                    <tr>
                    ...
                    <section id="size-chart-tab-content__denim" class="tab-panel">
                        <div class="size-chart-tab-content__wrap-tbl mb__40">
                            <h5 class="mb__20 fs__16">Denim Size Chart (Inch)</h5>
                            <div class="table-responsive">
                                <table class="sizeguide_table w__100 m-0">
                                    <tbody>
                                    <tr>
                        ...
                        <div class="size-chart-tab-content__wrap-tbl">
                            <h5 class="mb__20 fs__16">Denim Size Chart (cm)</h5>
                            <div class="table-responsive">
                                <table class="sizeguide_table w__100 m-0">
                                    <tbody>
                                    <tr>
                    ...
                    <section id="size-chart-tab-content__swimwear" class="tab-panel">
                        <div class="size-chart-tab-content__wrap-tbl mb__40">
                            <h5 class="mb__20 fs__16">Swimwear Size Chart (Inch)</h5>
                            <div class="table-responsive">
                                <table class="sizeguide_table w__100 m-0">
                                    <tbody>
                                    <tr>
                        ...
                        <div class="size-chart-tab-content__wrap-tbl">
                            <h5 class="mb__20 fs__16">Swimwear Size Chart (cm)</h5>
                            <div class="table-responsive">
                                <table class="sizeguide_table w__100 m-0">
                                    <tbody>
                                    <tr>
                    ...
                    <section id="size-chart-tab-content__shoes" class="tab-panel">
                        <div class="size-chart-tab-content__wrap-tbl">
                            <h5 class="mb__20 fs__16">Shoes Size Chart</h5>
                            <div class="table-responsive">
                                <table class="sizeguide_table w__100 ml-auto mr-auto mb-0 mt-0">
                                    <tbody>
                                    <tr>
            ...
            <h4 class="text-center mb__50">+1 (646) 389-7242</h4>
        </div>
