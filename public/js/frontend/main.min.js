! function(e) {
    ...
    var t = {
        ...
        owlCarousels: function() {
            var t = { loop: !0, margin: 0, responsiveClass: !0, nav: !1, navText: ['<i class="fas fa-chevron-left">', '<i class="fas fa-chevron-right"></i>'], dots: !0, autoplay: !0, autoplayTimeout: 15e3, items: 1 },
                i = function(i, o) {
                    var n;
                ...
                o = {
                    ".home-slider": { lazyLoad: !0, autoplay: !1, dots: !1, nav: !0, autoplayTimeout: 12e3, animateOut: "fadeOut", navText: ['<i class="fas fa-chevron-left">', '<i class="fas fa-chevron-right"></i>'], loop: !0 },
                    ...
                    ".widget-featured-products": { lazyLoad: !0, nav: !0, navText: ['<i class="fas fa-chevron-left">', '<i class="fas fa-chevron-right"></i>'], dots: !1, autoHeight: !0 },
