            ...
            <div class="col-lg-8 product-single-gallery">
               <div class="row">
                  <div class="col-sm-6 product-item">
                     <div class="inner">
                        <img src="<?php echo asset('images/ecommerce/products/zoom/product-1.jpg');?>" data-zoom-image="<?php echo asset('images/ecommerce/products/zoom/product-1-big.jpg');?>" alt="product name">
