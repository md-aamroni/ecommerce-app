		...
		<div class="row">
			<div class="col-lg-9 main-content">
							...
							<div class="product-slider-container">
								<div class="product-single-carousel owl-carousel owl-theme">
									<div class="product-item">
										<img class="product-single-image" src="<?php echo asset('images/ecommerce/products/zoom/product-1.jpg'); ?>" data-zoom-image="assets/images/products/zoom/product-1-big.jpg');?>" />
									</div>
									<div class="product-item">
										<img class="product-single-image" src="<?php echo asset('images/ecommerce/products/zoom/product-2.jpg'); ?>" data-zoom-image="assets/images/products/zoom/product-2-big.jpg');?>" />
									</div>
									<div class="product-item">
										<img class="product-single-image" src="<?php echo asset('images/ecommerce/products/zoom/product-3.jpg'); ?>" data-zoom-image="assets/images/products/zoom/product-3-big.jpg');?>" />
									</div>
									<div class="product-item">
										<img class="product-single-image" src="<?php echo asset('images/ecommerce/products/zoom/product-4.jpg'); ?>" data-zoom-image="assets/images/products/zoom/product-4-big.jpg');?>" />
									</div>
								</div>
				...
				<div class="product-single-tabs scrolling-box">
					<div class="sticky-header pt-0 pb-0" role="tablist">
						<div class="container">
					...
					<div class="tab-pane" id="product-desc-content" role="tabpanel" aria-labelledby="product-tab-desc">
						<div class="product-desc-content">
							...
							<ul>
								<li><i class="fas fa-ok"></i>Any Product types that You want - Simple, Configurable</li>
								<li><i class="fas fa-ok"></i>Downloadable/Digital Products, Virtual Products</li>
								<li><i class="fas fa-ok"></i>Inventory Management with Backordered items</li>
							</ul>
				...
				<div class="sidebar-wrapper">
					<div class="widget widget-info">
						<ul>
							...
							<li>
								<i class="fas fa-us-dollar"></i>
								<h4>100% MONEY<br>BACK GUARANTEE</h4>
							</li>
							<li>
								<i class="fas fa-online-support"></i>
