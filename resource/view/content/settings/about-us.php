			...
			<div class="card">
				...
				<div class="card-body pb-1">
					<form action="" method="POST" autocomplete="off">
						...
						<input type="hidden" name="update_id" value="<?php echo @$aboutUs[0]['id'];?>" />
						<div class="form-group">
							<textarea name="details" id="summernote"><?php echo @$aboutUs[0]['details'];?></textarea>
						</div>
						<div class="form-group">
							<button type="submit" class="btn btn-primary" name="submitAboutUs">
							<i class="fas fa-plus mr-1"></i><?php echo !empty($aboutUs[0]['id']) ? 'Confirm and Update' : 'Confirm and Submit';?>
							</button>
						</div>
					</form>
				</div>
