		...
		<nav class="mobile-nav">
			<ul class="mobile-menu">
				...
				<li>
					...
					<ul>
						<li><a href="https://www.portotheme.com/html/porto_ecommerce/demo_9/category-banner-full-width.php">Full Width Banner</a></li>
						<li><a href="category-banner-boxed-slider.php">Boxed Slider Banner</a></li>
						<li><a href="category.php">Boxed Image Banner</a></li>
		...
		<div class="modal-content">
			<div class="modal-body add-cart-box text-center">
				...
				<div class="btn-actions">
					<a href="cart.php"><button class="btn-primary">Go to cart page</button></a>
